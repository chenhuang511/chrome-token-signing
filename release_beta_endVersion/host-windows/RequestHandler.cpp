...
void RequestHandler::validateSecureOrigin() {
	...
	//De chay duoc trong file hwcripto: file:///C:/Users/vanhaIT/Desktop/hwcrypto.js/dist/sign.html ta cmt doan code nay lai
...
void RequestHandler::handleSignRequest() {
	...
	validateContext(*signer->getCertInHex()); //chinh la certId
	//_log("validate: %s", signer->getCertInHex()->c_str());
